...
from shades.estimators import ExactEstimator, ShadowEstimator
from shades.utils import make_hydrogen_chain
from shades.monte_carlo import WavefunctionSampler, MPSSampler, MetropolisSampler, MonteCarloEstimator, _gen_single_site_hops
...
DEFAULT_OUTPUT_DIR = "./results/rdm2_convergence/test/"

N_RUNS = 10
N_MC_ITERS = [10000]
N_SHADOWS = [1000, 5000, 10000, 20000, 50000]
N_K_ESTIMATORS = 20

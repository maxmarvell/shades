...
The prefactor C in Var(E) = C / N_s^alpha is extracted via a least-squares fit
in log-space and annotated on the figure.

Usage:
    python scripts/tomography/clifford/plot_convergence.py <results_directory>

Example:
    python scripts/tomography/clifford/plot_convergence.py results/tomography/clifford/convergence/2026-02-23_12-00-00/
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot convergence from Clifford shadow budget sweep results directory."
    )
